        ...
        <div className="px-5 pb-24">
          <div className="max-w-md mx-auto space-y-8">
            ...
            <div>
              ...
              <div className={`p-4 ${theme === "light" ? "bg-gray-100" : "bg-zinc-800/60"} backdrop-blur-sm rounded-lg`}>
                <div className="mb-3">
              ...
              <div className="space-y-3">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 ${theme === "light" ? "bg-white !text-black/95 placeholder-black/50 border border-gray-300" : "bg-zinc-800/60 !text-white/95 placeholder-white/50"} rounded-lg focus:outline-none text-lg`}
                  />
                </div>
