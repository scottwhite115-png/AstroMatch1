          ...
          <div className={`space-y-6 ${theme === "light" ? "text-gray-800" : "text-white/80"}`}>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    Rooster × Ox — Same Trine (San He 三合)
                  </h3>
                  <p className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    Efficient and exacting
                  </p>
                  <p>
                    Rooster and Ox share the San He (三合) Strategic trine, creating a strong, focused, and highly dependable bond. Rooster contributes insight and refinement; Ox offers patience and practical strength. You align naturally around commitment and long-term goals. This is one of Rooster's most stable and harmonious partnerships.
                  </p>
                </div>

                <div>
                  <h3 className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    Rooster × Tiger — Neutral
                  </h3>
                  <p className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    Pride and critique
                  </p>
                ...
                <div>
                  <h3 className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    Rooster × Rabbit — Clash Pair (Liu Chong 六冲)
                  </h3>
                  <p className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    Delicate vs. direct
                  </p>
                ...
                <div>
                  <h3 className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    Rooster × Dragon — Secret Friend (Liu He 六合)
                  </h3>
                  <p className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    Show and precision
                  </p>
                  <p>
                    Rooster and Dragon share a Liu He (六合) harmony built on mutual vision, loyalty, and clarity. Rooster adds refinement and strategy; Dragon contributes strength and inspiration. Together, you create stability and forward momentum. This is a deeply supportive and capable partnership.
                  </p>
                </div>

                <div>
                  <h3 className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    Rooster × Snake — Same Trine (San He 三合)
                  </h3>
                  <p className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    Exact and incisive
                  </p>
                  <p>
                    Rooster and Snake form part of the San He (三合) Strategic trine, creating a sharp, perceptive, and intellectually attuned match. Snake brings calm wisdom; Rooster brings precision and focus. The connection feels steady, insightful, and deeply complementary. This is one of Rooster's strongest and most reliable matches.
                  </p>
                </div>

                <div>
                  <h3 className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    Rooster × Horse — Neutral
                  </h3>
                  <p className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    Pace and precision
                  </p>
                ...
                <div>
                  <h3 className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    Rooster × Rooster — Same Sign (Self-Punishment 相刑)
                  </h3>
                  <p className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    High standards
                  </p>
                  <p>
                    Two Roosters create a relationship full of clarity, drive, and high standards. But as a self-punishment Xing (相刑) pairing, perfectionism and critique can escalate quickly. The connection becomes strong and purposeful when appreciation leads. Warmth softens intensity and allows this match to thrive.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Rooster prioritises accuracy and directness, while Dog seeks sincerity and emotional truth — creating mismatched communication rhythms. Dog brings devotion and integrity; Rooster brings focus and accountability. Sensitivity and pacing are essential. The bond can work with gentleness but remains delicate.
                  </p>
                </div>
