-- ============================================================================
-- ASTROMATCH - MAIN DATABASE MIGRATION
-- RUN THIS AFTER running 00_CLEANUP_FIRST.sql
-- ============================================================================
-- This creates all tables, functions, and policies for AstroMatch
-- ============================================================================
...
CREATE FUNCTION public.calculate_age(birthdate DATE)
RETURNS INTEGER AS $$
BEGIN
...
-- Age update trigger function
CREATE FUNCTION public.update_profile_age()
RETURNS TRIGGER AS $$
BEGIN
...
-- Auto-match function
CREATE FUNCTION public.check_and_create_match()
RETURNS TRIGGER AS $$
DECLARE
...
-- Cleanup expired passes function
CREATE FUNCTION public.cleanup_expired_passes()
RETURNS INTEGER AS $$
DECLARE
...
CREATE FUNCTION public.update_match_timestamp()
RETURNS TRIGGER AS $$
BEGIN
...
CREATE FUNCTION public.mark_message_read(message_id UUID)
RETURNS VOID AS $$
BEGIN
...
CREATE FUNCTION public.mark_match_messages_read(match_id_param UUID)
RETURNS INTEGER AS $$
DECLARE
...
CREATE FUNCTION public.update_message_timestamp()
RETURNS TRIGGER AS $$
BEGIN
  NEW.updated_at = NOW();
  RETURN NEW;
...
-- Geo search function
CREATE FUNCTION public.profiles_within_radius(
...
-- ============================================
-- MIGRATION 006: REPORTS AND BLOCKS
-- ============================================
...
DO $$ BEGIN
  ...
  RAISE NOTICE 'Next: Create storage bucket in Supabase Dashboard UI';
END $$;
