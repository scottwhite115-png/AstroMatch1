-- ============================================================================
-- ASTROMATCH - COMBINED DATABASE MIGRATIONS
-- RUN THIS ONCE IN SUPABASE SQL EDITOR TO SET UP YOUR DATABASE
-- ============================================================================
-- This file combines all 5 migrations:
--   001: Enhance Profiles Schema
--   002: Likes, Matches, Passes Tables  
--   003: Messages System
--   004: Storage Buckets
--   005: Geo Search Function
-- ============================================================================
...
-- ============================================================================
-- What was created:
--   ✓ Enhanced profiles table with 30+ new fields
--   ✓ Likes, matches, passes tables
--   ✓ Messages table with real-time support
--   ✓ Profile photos storage bucket
--   ✓ Geo-location search function
--   ✓ Automatic match detection trigger
--   ✓ All RLS policies for data security
--   ✓ Indexes for performance
--
-- Next steps:
--   1. Verify tables exist: SELECT * FROM profiles, likes, matches, messages;
--   2. Test the app with real accounts
