...
import { buildConnectionBox, deriveElement, deriveTrine } from "@/lib/compat/engine"
...
export default function ChatPage() {
  ...
  useEffect(() => {
    if (userAstro) {
      ...
      const box = buildConnectionBox(userAstro, profileAstro)
      setCompatBox(box)
    ...
    <div className={`${theme === "light" ? "bg-white" : "bg-zinc-900"} min-h-screen w-full fixed inset-0 flex flex-col`}>
      ...
      <div className={`flex items-center justify-center px-4 pt-2 relative z-10 ${theme === "light" ? "bg-white" : "bg-zinc-900"}`} style={{ minHeight: '60px' }}>
        <button
          ...
          className={`${theme === "light" ? "text-gray-700 hover:bg-gray-100" : "text-white/80 hover:bg-zinc-800/50"} absolute left-4 p-2 rounded-lg transition-colors`}
        >
        ...
        <div className="flex items-center gap-2 absolute right-4">
          ...
          <Button
            ...
            className={`${theme === "light" ? "text-gray-700 hover:bg-gray-100" : "text-white/80 hover:bg-zinc-800/50"}`}
          >
          ...
          <div className={`py-3 pb-32 relative z-10 ${theme === "light" ? "bg-white" : "bg-zinc-900"}`}>
            ...
            <div className="px-4 pb-2 flex gap-2">
              <Button
                ...
                className={`rounded-full w-12 h-12 p-0 ${theme === "light" ? "bg-gray-200 hover:bg-gray-300 text-gray-700" : "bg-zinc-800/60 hover:bg-zinc-800/80 text-white/80"}`}
              >
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 pr-14 outline-none ${theme === "light" ? "bg-gray-100 text-gray-900 placeholder:text-gray-500 border-t border-gray-200" : "bg-zinc-800/60 text-white/95 placeholder:text-white/50 border-t border-white/20"}`}
              />
              <Button
                onClick={handleSend}
          ...
          >
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl outline-none bg-zinc-800 !text-white/95 placeholder:!text-white/50 border border-white/20"
              />
            </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {gifs.map((gif: any) => (
                    <button
                      ...
                      className="relative aspect-square rounded-xl overflow-hidden hover:opacity-80 transition-opacity bg-zinc-800"
                    >
                      <img
