...
export function BottomNavigation() {
  ...
  const handleNavClick = (path: string) => {
    ...
    // If clicking Likes while on likes page with a profile open, close the profile
    else if (path === "/likes" && pathname === "/likes") {
      window.dispatchEvent(new Event("closeProfile"))
    } else {
      router.push(path)
    }
  }
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden pb-safe">
      ...
      <div className="relative w-full h-20">
        ...
        <div className="relative grid grid-cols-5 w-full h-full items-start pt-2">
