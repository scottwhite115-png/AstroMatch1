...
export const patternDefinitions: Record<ChinesePatternType, PatternDefinition> = {
  ...
  liu_he: {
    key: "liu_he",
    label: "Liu He (六合) — Six Harmonies (Modern Six Harmoniess)",
    hanzi: "六合",
    pinyin: "Liù Hé",
    translation: "Six Harmonies (Modern Six Harmoniess)",
    headlineTag: "Six Harmonies (Modern Six Harmoniess)",
    tone: "supportive",
    tagline: "Secret-friend style support — quietly stabilising and protective.",
    blurbHint: "This sits under Liu He (六合), the 'Six Harmonies' pattern — one of the 12 official 'Six Harmonies' combinations used in modern Chinese astrology. Traditionally seen as a supportive, stabilising bond where each sign softens the other's edges and helps life feel more manageable.",
    shortDescription: "Modern Six Harmoniess – one of 12 official Liu He pairs. Quietly supportive, easing tensions and helping each other stabilise and progress.",
  },
  liu_chong: {
    key: "liu_chong",
    label: "Liu Chong (六冲)",
