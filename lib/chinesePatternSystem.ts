...
const patternBasedData: PatternBasedData = {
  ...
  goat: {
    san_he: ["rabbit"], // Rabbit+Goat is san_he (same trine), Goat+Pig is po per classical variant
    liu_he: ["horse"],
    liu_chong: ["ox"],
    liu_hai: ["rat"],
    xing: ["ox", "dog"],
    po: ["pig"], // Goat+Pig is one of the 6 classical Po pairs
    friendly: [],
  },
  monkey: {
    san_he: ["rat", "dragon"],
  ...
  pig: {
    san_he: ["rabbit"], // Rabbit+Pig is san_he (same trine)
    liu_he: ["tiger"],
    liu_chong: ["snake"],
    liu_hai: ["monkey"], // Monkey × Pig is Liu Hai (Six Harms)
    xing: ["pig"],
    po: ["goat"], // Goat+Pig can be Po in some classical interpretations
    friendly: [],
  },
};
