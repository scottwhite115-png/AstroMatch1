// lib/compatibility/chinesePatternLine.ts

export const chinesePatternLine: Record<
  "SAN_HE" | "LIU_HE" | "NEUTRAL" | "SAME_SIGN" | "SAME_SIGN_XING" | "LIU_CHONG" | "LIU_HAI" | "PO",
  string
> = {
  ...
  LIU_CHONG: "Liu Chong (六冲) \"Six Conflicts\" — Opposing forces creating dynamic tension and potential for transformation.",
  LIU_HAI: "Liu Hai (六害) \"Six Harms\" — Challenging pattern requiring patience, understanding, and conscious effort to navigate.",
  PO: "Po (破) \"Break\" — Disruptive pattern that can lead to growth through overcoming obstacles together.",
};
