            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p>
                    Horse and Rat differ sharply in rhythm and priorities — Rat plans ahead while Horse moves on instinct. Rat brings strategy and caution; Horse brings momentum and independence. The connection can feel charged and effortful without pacing. This pairing has vivid chemistry but contrasting emotional tempos.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Ox prefers reliability and steady structure, while Horse thrives on motion and freedom. These differences create subtle emotional erosion over time. Ox offers grounding; Horse brings spark and change. The bond feels contrasting, requiring space and awareness to stay balanced.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Horse and Tiger belong to the San He (三合) Adventurer trine, creating a vibrant, bold, and forward-moving match. Tiger brings courage and intensity; Horse adds enthusiasm and momentum. Together the connection feels dynamic, inspired, and full of shared drive. This is one of Horse's most naturally energising pairings.
                  </p>
                </div>

                <div>
                  <h3 className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    Horse × Rabbit — Break (Po 破)
                  </h3>
                  <p className={`text-base font-semibold mb-2 ${theme === "light" ? "text-gray-800" : "text-white/90"}`}>
                    Calm vs. restless
                  </p>
                  <p>
                    Rabbit seeks calm clarity, while Horse responds quickly to instinct — creating a mismatch in pacing. Rabbit brings sensitivity and gentleness; Horse adds motion and initiative. This pairing works when rhythms align deliberately. The connection is soft but easily unsettled by timing differences.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Horse and Dragon share energy, confidence, and a taste for movement, creating an exciting and forward-leaning match. Dragon brings presence and charisma; Horse brings freedom and spontaneity. The relationship feels bright and adventurous. Independence needs balance to keep the energy steady.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Snake moves quietly and thoughtfully, while Horse acts quickly and openly. Snake offers depth and reflection; Horse brings optimism and drive. This pairing grows through appreciation of contrast. The tone feels dynamic, subtle, and shaped by pacing.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Two Horses create a lively, passionate connection full of motion, instinct, and shared excitement. As a self-punishment Xing (相刑) match, restlessness and impatience can escalate quickly. The relationship feels spirited, bold, and fast-moving. Grounding and steadiness define its long-term strength.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Horse and Goat share a gentle Liu He (六合) harmony, forming a warm and emotionally supportive bond. Goat brings softness and creativity; Horse adds inspiration and confidence. The connection feels nurturing and uplifting. This is one of Horse's most comforting and heartfelt matches.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Horse and Monkey share bright energy, curiosity, and quick minds, creating a playful and lively dynamic. Monkey brings clever ideas; Horse brings initiative and spark. The bond feels adventurous and open-ended. Pacing and communication define its stability.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Horse relies on instinct and movement, while Rooster prefers clarity, precision, and planning. Rooster brings structure; Horse adds vitality and spontaneity. The connection feels contrasting but capable when each role is valued. This match thrives through shared goals and rhythm awareness.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Pig brings warmth, generosity, and emotional sincerity, while Horse brings motion, optimism, and independence. Together the connection feels gentle yet lively. This pairing works through pacing and mutual appreciation. The tone is warm, open, and quietly supportive.
                  </p>
                </div>
              </div>
