...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🔮 Calling Free Astrology API with:', {
      year: parseInt(year),
    ...
    const response = await fetch('https://json.freeastrologyapi.com/horoscope-chart-url', {
      method: 'POST',
      headers: {
    ...
    console.log('✅ Success! Chart data received');
