...
export default function ProfileViewPage() {
  ...
  const convertSimpleToConnectionBoxData = (
    ...
    // Map label to tier (updated with new labels)
    ...
    const labelToEmoji: Record<string, string> = {
      ...
      "Excellent Match": "✨",
      "Six Harmonies": "💕",
      "Secret Friends Match": "💕", // Legacy support
      "Favourable Match": "✨",
      "Good Friends": "✨",
      "Good Friends Match": "✨",
      "OPPOSITES_ATTRACT": "⚡",
      ...
      "Opposites Attract": "⚡",
      "Six Conflicts": "⚡",
      "Magnetic Opposites": "⚡", // Legacy support
      "NEUTRAL": "✨",
      "NEUTRAL MATCH": "✨",
      "Neutral Match": "✨",
      "Six Harms": "⚠️",
      "Punishment": "⚖️",
      "Breakpoint": "💥",
      "Challenging Match": "⚠️", // Legacy support
      "DIFFICULT": "💔",
      "DIFFICULT MATCH": "💔",
      "Difficult Match": "💔",
    };
    ...
    const labelToColor: Record<string, string> = {
      ...
      "Six Harmonies": "rgb(168, 85, 247)",
      "Secret Friends Match": "rgb(168, 85, 247)", // Legacy support
      ...
      "Opposites Attract": "rgb(239, 68, 68)",
      "Six Conflicts": "rgb(249, 115, 22)",
      "Magnetic Opposites": "rgb(249, 115, 22)", // Legacy support
      "NEUTRAL": "rgb(34, 139, 34)",
      "NEUTRAL MATCH": "rgb(34, 139, 34)",
      "Neutral Match": "rgb(34, 139, 34)",
      "Six Harms": "rgb(244, 63, 94)",
      "Punishment": "rgb(239, 68, 68)",
      "Breakpoint": "rgb(239, 68, 68)",
      "Challenging Match": "rgb(244, 63, 94)", // Legacy support
  ...
  const handleImageTouchStart = (e: React.TouchEvent) => {
    if (e.touches.length === 2) {
      ...
      // Allow normal scrolling for single finger - don't prevent default
      lastTouchPosRef.current = { x: e.touches[0].clientX, y: e.touches[0].clientY }
    }
  }
  ...
  return (
    <div className="bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 min-h-screen pb-24">
      <div className="relative z-10 max-w-md mx-auto">
        ...
        {/* Action Buttons */}
        <div className="px-4 pb-8 mt-4 mb-32">
