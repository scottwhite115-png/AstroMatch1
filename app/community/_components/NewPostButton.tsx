              ...
              <div className="mx-auto max-w-2xl px-4 py-6">
                ...
                <div>
                  <select
                    ...
                    className={`w-full rounded-xl border px-4 py-4 text-base outline-none focus:ring-2 focus:ring-emerald-500/70 focus:border-emerald-500 ${
                      theme === "light"
                  ...
                  >
                    {COMMUNITY_TOPICS.map((t) => (
                      <option key={t.id} value={t.id} style={{ fontSize: '1rem', padding: '8px' }}>
                        {t.icon} {t.label}
                      </option>
                    ))}
                  </select>
