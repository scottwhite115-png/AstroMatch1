...
export default function ZodiacCombinationPage({ params }: ZodiacCombinationPageProps) {
  ...
  if (!mounted) {
    return (
      <div className="mobile-container">
        <div className={`${theme === "starlight" ? "astrology-cosmic-bg" : theme === "light" ? "bg-white" : "bg-zinc-900"} min-h-screen flex items-center justify-center`}>
  ...
  return (
    <div className="mobile-container">
      <div
        className={`${theme === "starlight" ? "astrology-cosmic-bg" : theme === "light" ? "bg-white" : "bg-zinc-900"} combination-page min-h-screen pb-20`}
      >
