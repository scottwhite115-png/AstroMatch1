...
export default function SafetyPrivacyPage({
  ...
  return (
    <div
      className={`${theme === "light" ? "bg-white" : "bg-[#0a0a0a]"} profile-page min-h-screen relative overflow-x-hidden touch-pan-y`}
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="px-5 pb-32">
          ...
          <div className="mb-8">
            <h2
              className="font-semibold text-base mb-4 text-rank-purple/90 dark:text-purple-300"
            >
              Notifications
            </h2>
            <div className="space-y-3">
              <div className={`flex items-center justify-between p-4 ${theme === "light" ? "bg-gray-100" : "bg-zinc-800/60"} backdrop-blur-sm rounded-lg`}>
                <div>
            ...
            {blockedUsers.length > 0 ? (
              <div className="space-y-3">
                {blockedUsers.map((user) => (
                  <div
                    key={user.id}
                    className={`flex items-center justify-between p-4 ${theme === "light" ? "bg-gray-100 border-gray-300" : "bg-zinc-800/60 border-gray-400/60"} backdrop-blur-sm rounded-lg border`}
                  >
              ...
              <div className={`p-6 ${theme === "light" ? "bg-gray-100" : "bg-zinc-800/60"} backdrop-blur-sm rounded-lg text-center`}>
            ...
            <div className="space-y-3">
              {safetyResources.map((resource, index) => (
                <a
                  ...
                  className={`block p-4 ${theme === "light" ? "bg-gray-100 hover:bg-gray-200" : "bg-zinc-800/60 hover:bg-zinc-800/80"} backdrop-blur-sm rounded-lg transition-colors`}
                >
          ...
          <div className="mb-8">
            ...
            <div className={`${theme === "light" ? "bg-gray-100" : "bg-zinc-800/60"} backdrop-blur-sm rounded-lg overflow-hidden`}>
              <button
