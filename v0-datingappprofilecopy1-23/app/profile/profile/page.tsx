...
export default function AstrologyProfilePage({
  ...
  return (
    <div
      className={`${theme === "light" ? "light bg-white" : "bg-[#0a0a0a]"} profile-page min-h-screen relative overflow-x-hidden touch-pan-y`}
      ...
      <div className="relative z-10">
        ...
        {activeTab === "edit" && (
          <div className="px-7 pb-32">
            ...
            <div
              className={`mb-4 p-5 rounded-lg -mx-5 ${theme === "starlight" ? "bg-white/5 backdrop-blur-sm border border-white/10" : theme === "light" ? "bg-white border border-gray-200 shadow-sm" : "bg-zinc-800/60 backdrop-blur-sm shadow-sm"}`}
            >
              <h2
                className="font-semibold text-base mb-4 flex items-center gap-2 text-rank-purple/90 dark:text-purple-300"
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="rgb(168,85,247)" strokeWidth="2">
            ...
            <div
              className={`mb-4 p-5 rounded-lg -mx-5 relative ${theme === "starlight" ? "bg-white/5 backdrop-blur-sm border border-white/10" : theme === "light" ? "bg-white border border-gray-200 shadow-sm" : "bg-zinc-800/60 backdrop-blur-sm shadow-sm"}`}
              style={{ zIndex: 2147483640 }}
            >
              <h2
                className="font-semibold text-base mb-2 flex items-center gap-2 text-rank-purple/90 dark:text-purple-300"
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="rgb(168,85,247)" strokeWidth="2">
              ...
              <p className={`text-xs mb-2 ${theme === "starlight" ? "text-white/70" : theme === "light" ? "!text-black/50" : "text-white/70"}`}>
                The match engine relies on honest information
              </p>
              <div className="space-y-3">
                <div className="relative" ref={calendarRef} style={{ zIndex: 'auto' }}>
                  <button
                    type="button"
                    onClick={() => setShowCalendar(!showCalendar)}
                    className={`w-full px-4 py-3 rounded-xl focus:outline-none text-left flex items-center justify-between transition-all ${theme === "starlight" ? "border border-white/20 bg-white/5 text-white" : theme === "light" ? "border border-gray-300 bg-white text-black" : "bg-zinc-800/60 !text-white"}`}
                  >
                    <span className={`birth-date-display ${theme === "light" ? "!text-black" : "!text-white"}`} style={{ fontSize: '1rem' }}>{formatDisplayDate(birthInfo.birthdate)}</span>
                    <ChevronDown className={`w-5 h-5 ${theme === "starlight" ? "text-white/50" : theme === "light" ? "text-black/50" : "text-white/50"}`} />
                  </button>

                  {/* Zodiac Signs Display */}
                  {zodiacSigns.western && zodiacSigns.chinese && (
                    <Link 
                      href={`/astrology/${zodiacSigns.western.toLowerCase()}/${zodiacSigns.chinese.toLowerCase()}`}
                      className={`block mt-3 p-3 rounded-lg border transition-all duration-200 cursor-pointer ${theme === "light" ? "bg-gray-50 border-gray-200 hover:bg-gray-100 hover:border-gray-300" : "bg-zinc-800/60 border-zinc-700/50 hover:bg-zinc-700/60 hover:border-zinc-600/50"}`}
                    >
                      <div className="flex items-end justify-center gap-4">
                        <div className="text-center flex flex-col items-center">
                          <div className="text-2xl mb-1">{getWesternSignEmoji(zodiacSigns.western)}</div>
                          <div className={`text-sm font-medium ${theme === "light" ? "text-black/90" : "text-white/90"}`}>{zodiacSigns.western}</div>
                        </div>
                        <div className={`text-lg mb-0.5 ${theme === "light" ? "text-black/60" : "text-white/60"}`}>+</div>
                        <div className="text-center flex flex-col items-center">
                          <div className="text-3xl mb-1">{getChineseSignEmoji(zodiacSigns.chinese)}</div>
                          <div className={`text-sm font-medium ${theme === "light" ? "text-black/90" : "text-white/90"}`}>{zodiacSigns.chinese}</div>
                        </div>
                      </div>
                    </Link>
                  )}
                  ...
                  {showCalendar && (
                    <>
                      {/* Backdrop */}
                      <div className="fixed inset-0 bg-black/20" style={{ zIndex: 2147483646 }} onClick={() => setShowCalendar(false)} />
                      {/* Calendar */}
                      <div className={`absolute top-full left-0 right-0 mt-2 backdrop-blur-sm rounded-lg shadow-2xl p-3 ${theme === "light" ? "bg-white border border-gray-200" : "bg-black/95"}`} style={{ zIndex: 2147483647 }}>
                      {!showYearPicker ? (
                        <>
                          {/* Calendar Header */}
                          <div className="flex items-center justify-between mb-4">
                            ...
                            >
                              <ChevronLeft className={`w-7 h-7 ${theme === "light" ? "text-black" : "text-white"}`} />
                            </button>
                            <button
                              onClick={() => setShowYearPicker(true)}
                              className={`font-semibold hover:bg-white/10 px-3 py-1 rounded-lg transition-colors ${theme === "light" ? "text-black" : "text-white"}`}
                            >
                            ...
                            <button
                              ...
                              className="p-2 hover:bg-white/10 rounded-lg transition-colors"
                            >
                              <ChevronRight className={`w-7 h-7 ${theme === "light" ? "text-black" : "text-white"}`} />
                            </button>
                          </div>
                          ...
                          <div className="grid grid-cols-7 gap-1">
                            ...
                            {["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"].map((day) => (
                              <div key={day} className="text-center text-xs font-medium py-2">
                                <span className={theme === "light" ? "text-black" : "text-white"}>{day}</span>
                              </div>
                            ))}
                        ...
                        <>
                          <div className="flex items-center justify-between mb-4">
                            <button
                              ...
                              className={`hover:text-white/80 text-sm transition-colors ${theme === "light" ? "text-black hover:text-black/80" : "text-white"}`}
                            >
                              ← Back
                            </button>
                            <div className={`font-semibold ${theme === "light" ? "text-black" : "text-white"}`}>Select Year</div>
            ...
            >
              ...
              <div className="space-y-4">
                <input
                  ...
                  maxLength={30}
                  className={`w-full px-4 py-3 rounded-xl focus:outline-none transition-all occupation-input ${theme === "starlight" ? "border border-white/20 bg-white/5 text-white placeholder-white/40" : theme === "light" ? "border border-gray-300 bg-white text-black placeholder-black/40" : "bg-zinc-800/60 !text-white/95 placeholder-white/40"}`}
                  style={{ fontSize: '1rem' }}
                />
              ...
              <div className="space-y-4">
                <div className="relative" ref={cityInputRef}>
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl focus:outline-none transition-all location-input !text-xl ${theme === "starlight" ? "border border-white/20 bg-white/5 text-white placeholder-white/40" : theme === "light" ? "border border-gray-300 bg-white text-black placeholder-black/40" : "bg-zinc-800/60 !text-white/95 placeholder-white/40"}`}
            ...
            >
              ...
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="rgb(168,85,247)" strokeWidth="2">
                  <path d="M12 2v20M8 6l4-4 4 4M8 18l4 4 4-4"></path>
                </svg>
                Height
              </h2>
              <div className="space-y-4">
                <select
                  ...
                  className={`w-full px-4 py-3 rounded-xl focus:outline-none appearance-none cursor-pointer transition-all height-select !text-xl ${theme === "starlight" ? "border border-white/20 bg-white/5 text-white" : theme === "light" ? "border border-gray-300 bg-white text-black !bg-white !text-black" : "bg-zinc-800/60 !text-white"}`}
                  style={{
            ...
            >
              ...
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="rgb(168,85,247)" strokeWidth="2">
                  ...
                  <path d="M12 14c-4.42 0-8 2.69-8 6v2h16v-2c0-3.31-3.58-6-8-6z"></path>
                </svg>
                Children
              </h2>
              <div className="space-y-4">
                <select
                  ...
                  className={`w-full px-4 py-3 rounded-xl focus:outline-none appearance-none cursor-pointer transition-all children-select !text-xl ${theme === "starlight" ? "border border-white/20 bg-white/5 text-white" : theme === "light" ? "border border-gray-300 bg-white text-black !bg-white !text-black" : "bg-zinc-800/60 !text-white"}`}
                  style={{
                    backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 20 20'%3e%3cpath stroke='%23${theme === "light" ? "000000" : "ffffff"}' strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M6 8l4 4 4-4'/%3e%3c/svg%3e")`,
                    backgroundPosition: "right 0.75rem center",
                    backgroundRepeat: "no-repeat",
            ...
            >
              ...
              <div className="space-y-4">
                <select
                  ...
                  className={`w-full px-4 py-3 rounded-xl focus:outline-none appearance-none cursor-pointer transition-all religion-select !text-xl ${theme === "starlight" ? "border border-white/20 bg-white/5 text-white" : theme === "light" ? "border border-gray-300 bg-white text-black !bg-white !text-black" : "bg-zinc-800/60 !text-white"}`}
                  style={{
                    backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 20 20'%3e%3cpath stroke='%23${theme === "light" ? "000000" : "ffffff"}' strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M6 8l4 4 4-4'/%3e%3c/svg%3e")`,
                    backgroundPosition: "right 0.75rem center",
                    backgroundRepeat: "no-repeat",
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  <select
                    value={genderOrientation.gender}
                    onChange={(e) => {
                      const newGenderOrientation = { ...genderOrientation, gender: e.target.value }
                      setGenderOrientation(newGenderOrientation)
                      if (typeof window !== 'undefined') {
                        localStorage.setItem("genderOrientation", JSON.stringify(newGenderOrientation))
                      }
                    }}
                    className={`w-full px-4 py-3 rounded-xl focus:outline-none transition-all gender-select !text-xl ${theme === "starlight" ? "border border-white/20 bg-white/5 text-white" : theme === "light" ? "border border-gray-300 bg-white text-black" : "bg-zinc-800/60 !text-white"}`}
                    style={{ fontSize: '1.25rem !important' }}
                  >
                    <option value="Man" style={{ fontSize: "0.625rem" }}>
                      Man
                    </option>
                    <option value="Woman" style={{ fontSize: "0.625rem" }}>
                      Woman
                    </option>
                  </select>
                </div>
            ...
            >
              <h2
                className="font-semibold text-base mb-1 flex items-center gap-2 text-rank-purple/90 dark:text-purple-300"
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="rgb(168,85,247)" strokeWidth="2">
                  <circle cx="12" cy="12" r="10"></circle>
              ...
              <p className={`text-sm mb-4 ${theme === "light" ? "text-black/40" : "text-white/40"}`}>
                Interested in
              </p>
              <div className="space-y-4">
                <div>
                  <select
                    value={genderOrientation.orientation}
                    onChange={(e) => {
                      const newGenderOrientation = { ...genderOrientation, orientation: e.target.value }
                      setGenderOrientation(newGenderOrientation)
                      if (typeof window !== 'undefined') {
                        localStorage.setItem("genderOrientation", JSON.stringify(newGenderOrientation))
                      }
                    }}
                    className={`w-full px-4 py-3 rounded-xl focus:outline-none transition-all orientation-select !text-xl ${theme === "starlight" ? "border border-white/20 bg-white/5 text-white" : theme === "light" ? "border border-gray-300 bg-white text-black" : "bg-zinc-800/60 !text-white"}`}
                    style={{ fontSize: '1.25rem !important' }}
                  >
                    <option value="Men" style={{ fontSize: "0.625rem" }}>
                      Men
                    </option>
                    <option value="Women" style={{ fontSize: "0.625rem" }}>
                      Women
                    </option>
                  </select>
                </div>
            ...
            >
              ...
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="rgb(168,85,247)" strokeWidth="2">
                  <circle cx="12" cy="10" r="3"></circle>
                  <path d="M12 2v8M12 10l-3 3M12 10l3 3"></path>
